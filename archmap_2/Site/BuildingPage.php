		...
		<script>
			...
			$(function() {
				...
				var dataStore = new DataStore();
					dataStore.getModel("Building", id, callback);
				// GET MODEL DATA: DONE
			...
			//alert("have data");
				// GET COVER ART
				$("#coverArt").html('<img src="'+model.attrs.poster_url+'" />');
				$("#pubTitle").html(model.attrs.name);
				$("#pubContributors").html('<b>'+model.attrs.date+'</b>');
			}
		...
		<div class="transp">
			...
			<table >
				<tr  style="font-size:36;font-weight:bold;">
					...
					<td>
							<span style="margin-left:10; color: #ddd;">Building</span>
					</td>
				</tr>
			...
			<!-- kineticjs stage -->
			<div style="width: 100%; height: 500px;background-color: #eee;  border-top: 1px solid gold;border-bottom: 1px solid gold;position: relative;" class="scrollable">
