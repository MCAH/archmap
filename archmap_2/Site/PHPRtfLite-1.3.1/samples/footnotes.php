...
$parFormat->setSpaceBetweenLines(2);


// restart footnote numbering on each page
$rtf->setRestartFootnoteNumberEachPage();

$font = new PHPRtfLite_Font(12, 'Times', '#000066');
$defaultFontForNotes = new PHPRtfLite_Font(12);
...
$sect->writeText($sectionText, $font, $parFormat);
...
$rtf->save($_SERVER['DOCUMENT_ROOT'] . "/archmap_2/test.rtf");
/*
